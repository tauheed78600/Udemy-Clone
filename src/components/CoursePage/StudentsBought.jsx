      ...
      <div>
        {coursesToShow.map((course, idx) => (
          <div key={idx} className="mt-4">
            <div className="flex flex-col md:flex-row gap-4 items-start mb-6 hover:scale-105 transition-transform duration-300 ease-in-out">
                <img
              ...
              <div className="flex-1">
                <p className="font-extrabold text-sm">{course.topic}</p>
